...
export default function DmeCard() {
  // Define the images to display in the carousel
  const images = [
    './images/flyers/dme1.jpg',
    './images/flyers/dme2.jpg',
    './images/flyers/dme3.jpg',
    './images/flyers/dme4.jpg',
    './images/flyers/dme5.jpg',
    './images/flyers/dme6.jpg',
  ];
  ...
  return (
    <div className="flex justify-center items-center h-screen ">
      ...
      >
        ...
        <span className='text-2xl '>Flyer Djib Movers Express</span>
        <p className='text-sm '>Ces flyer sont realiser pour la société de demenagement DME </p>
      </div>
    </div>
