...
export default function LogosCard() {
  ...
  return (
    <div className="flex justify-center items-center h-screen ">
      ...
      >
        ...
        <span className='text-2xl '>LOGOS </span>
        <p className='text-sm mt-5'>Quelque logos que j'ai pu réalié pour des particulier ou des agences </p>
      </div>
    </div>
